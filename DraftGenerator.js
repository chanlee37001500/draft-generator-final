...
export default function DraftGenerator() {
  ...
  return (
    <div>
      <h1>자동 기안서 생성기</h1>
      <p>스프레드시트에서 복사한 8개 셀을 탭으로 구분하여 붙여넣어 주세요.<br />순서: 날짜, 과정명, 행사명, 요청사항, 비목, 업체, 비용, 담당자</p>
      <textarea style={{ width: "100%", height: "100px" }} value={inputText} onChange={(e) => setInputText(e.target.value)} placeholder="예: 2025-03-31\t과정명\t행사명\t요청사항\t비목\t업체\t500000\t홍길동" />
